            ...
            <div class="pm-banner-content position-relative">
                <div class="pm-banner-text pm-headline pera-content">
                    ...
                    <a href="{{ route('check-in.step-one') }}">
                            <img  src="{{ asset('website/img/check-in-icon.png')}}" style="height: 40px;"><span>{{__('Visitor Self Check-in')}}</span>
                        </a>
                    </div>
                    <br>
                    ...
                    <a href="{{ route('check-out.index') }}">
                            <img  src="{{ asset('website/img/qr-icon.png')}}" style="height: 40px;"><span>{{__('Visitor Check-Out')}}</span>
                        </a>
                    </div>
                </div>
