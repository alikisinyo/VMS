                            ...
                            <div class="visitor" id="visitor">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <select id="employee_id" name="employee_id" class="form-control select2 @error('employee_id') is-invalid @enderror" onchange="showPhoneNumber()">
                                            @foreach($employees as $key => $employee)
                                                <option value="{{ $employee->id }}" data-phone="{{ $employee->phone }}" {{ (old('employee_id') == $employee->id) ? 'selected' : '' }}>{{ $employee->name }} ({{$employee->department->name}}) - {{ $employee->phone }}</option>
                                            @endforeach
                                        </select>
