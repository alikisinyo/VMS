...
{
    // Find the VisitingDetails by ID
    $visitingDetails = VisitingDetails::find($id);

    // Check if the VisitingDetails exists
    if ($visitingDetails) {
        // Delete the VisitingDetails
        $visitingDetails->delete();
        return true; // Return true to indicate successful deletion
    }

    return false; // Return false if the VisitingDetails does not exist
}
