...
class VisitorController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('admin.visitors.index')->withSuccess('The data was deleted successfully!');
        } catch (\Exception $e) {
            return redirect()->back()->withErrors(['error' => 'An error occurred while deleting the data. Please try again.']);
        }
    }
